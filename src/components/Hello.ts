...
export default class Index extends Vue {
    myVar = 'hi there';
    orienting = (window as any).DeviceOrientationEvent && !(this as any).$q.platform.is.desktop;
    rotating = (window as any).DeviceMotionEvent && !(this as any).$q.platform.is.desktop;
    moveX = 0;
    moveY = 0;
    rotateY = 0;
    rotateX = 0;
